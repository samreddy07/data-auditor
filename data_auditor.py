...
if csv_filename is not None:
    ...
    if selected_option == options[3]:
        ...
        col1.header("Bhavani")
        col1.image(Bhavani, use_column_width=True)
        image1=('Akhila.jpeg')
        Akhila = Image.open(image1)
        col2.header("Akhila")
        col2.image(Akhila, use_column_width=True)
        image2=('Mahesh.jpeg')
        Mahesh = Image.open(image2)
        col3.header("Mahesh")
        col3.image(Mahesh, use_column_width=True)
        image3=('Aiesha.jpeg')
        Aiesha = Image.open(image3)
        col4.header("Aiesha")
        col4.image(Aiesha, use_column_width=True)
        image4=('Afreen.jpeg')
        Afreen = Image.open(image4)
        col5.header("Afreen")
        col5.image(Afreen, use_column_width=True)

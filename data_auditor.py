...
if csv_filename is not None:
    ...
    if selected_option == options[3]:
        ...
        image=('sam.jpeg')
        Sam = Image.open(image)
        col1.header("Sam")
        col1.image(Sam, use_column_width=True)
        image1=('gnani.jpeg')
        Gnani = Image.open(image1)
        col2.header("Gnani")
        col2.image(Gnani, use_column_width=True)
        image2=('janhvi.jpeg')
        Janhvi = Image.open(image2)
        col3.header("Janhvi")
        col3.image(Janhvi, use_column_width=True)
        image3=('binayak.jpeg')
